...
enum Appearances {
    static func setUp() {
        ...
        /**
         ...
         reason: `Please file a radar on UIKit with this log if you see this assertion.
         selectorString = setKeyboardAppearance:,
         exercisedImplementation = { "setKeyboardAppearance:" = (); }`
         */
        //setUpTextView()
        setUpTextField()
    }
